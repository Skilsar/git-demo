...
public class FindAStore extends AbstractPage
{
    ...
    public FindAStore findAStore() throws InterruptedException {
        driver.findElement(By.xpath("//*[@class=\"head-search\"]")).click();
        driver.findElement(By.xpath("//input[@type='search']")).sendKeys("джемпер");
    ...
    //фильтрация по цене
    public FindAStore FilterOnPrice() throws InterruptedException {
